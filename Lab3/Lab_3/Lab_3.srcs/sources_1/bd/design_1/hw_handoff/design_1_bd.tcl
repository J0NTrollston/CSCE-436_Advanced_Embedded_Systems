...
proc create_root_design { parentCell } {
  ...
  set my_oscope_ip_0 [ create_bd_cell -type ip -vlnv unl.edu:user:my_oscope_ip:1.0 my_oscope_ip_0 ]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M02_AXI [get_bd_intf_pins microblaze_0_axi_periph/M02_AXI] [get_bd_intf_pins my_oscope_ip_0/S00_AXI]
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_ports sda] [get_bd_pins my_oscope_ip_0/sda]
  connect_bd_net -net Net1 [get_bd_ports scl] [get_bd_pins my_oscope_ip_0/scl]
  connect_bd_net -net ac_adc_sdata_0_1 [get_bd_ports ac_adc_sdata] [get_bd_pins my_oscope_ip_0/ac_adc_sdata]
  connect_bd_net -net btn_0_1 [get_bd_ports btn] [get_bd_pins my_oscope_ip_0/btn]
  ...
  connect_bd_net -net my_oscope_ip_0_ac_bclk [get_bd_ports ac_bclk] [get_bd_pins my_oscope_ip_0/ac_bclk]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs my_oscope_ip_0/S00_AXI/S00_AXI_reg] SEG_my_oscope_ip_0_S00_AXI_reg
