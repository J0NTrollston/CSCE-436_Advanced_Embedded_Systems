...
\FSM_sequential_FSM[1]_i_31\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
control: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_lab2_fsm
     port map (
      CO(0) => datapath_n_30,
      E(0) => control_n_3,
      \FSM_sequential_FSM_reg[0]_0\(0) => datapath_n_31,
...
datapath: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_lab2_datapath
     port map (
      ...
      \trigger_volt_S_reg[9]_0\(0) => datapath_n_31,
