...
HD_PWD='D:/UNL_Spring_2021/CSCE_436/Homework_3/Homework_3/Homework_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiple_of_17.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multiple_of_17.tcl -notrace
