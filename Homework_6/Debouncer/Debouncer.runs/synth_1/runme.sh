...
HD_PWD='D:/UNL_Spring_2021/CSCE_436/Homework_6/Debouncer/Debouncer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log leftRight.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source leftRight.tcl
