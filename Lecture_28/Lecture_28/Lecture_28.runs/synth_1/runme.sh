...
HD_PWD='D:/UNL_Spring_2021/CSCE_436/Lecture_28/Lecture_28/Lecture_28.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log digitalFilterDemo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source digitalFilterDemo.tcl
