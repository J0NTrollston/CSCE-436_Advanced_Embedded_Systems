...
HD_PWD='D:/UNL_Spring_2021/CSCE_436/Lecture_28/Lecture_28/Lecture_28.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log digitalFilterDemo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source digitalFilterDemo.tcl -notrace
