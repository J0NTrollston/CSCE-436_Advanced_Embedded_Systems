...
-- File: 	digitalFilterDemo.vhd
-- Project: Homework 12
-- Pupr:	low pass filter
--
-- Documentation:	Received help by TA Jacob Fox	
--                                   
-- 	
...
architecture struct of digitalFilterDemo is
	...
	signal L_filter_lpf1000, R_filter_lpf300 : std_logic_vector(17 downto 0);					
...
Audio_Codec : Audio_Codec_Wrapper
	...
	right_filter_lpf300: entity work.IIR_Biquad(arch)
		generic map	(	Coef_b0 => B"00_00_0000_0000_0110_0010_0101_0010_1000", 		-- +0.003916126
							Coef_b1 => B"00_00_0000_0000_1100_0100_1010_0101_0000",		-- +0.000750139
							Coef_b2 => B"00_00_0000_0000_0110_0010_0101_0010_1000",		-- +0.000375069
							Coef_a1 => B"10_00_0011_1000_1101_1010_1101_1001_0100",		-- -1.944477657
							Coef_a2 => B"00_11_1100_1000_1010_1110_0111_0000_1001")		-- 0.9459779362
		port map (
			clk => clk, 
			n_reset => reset_n, 
			sample_trig => ready, 
	...
	begin
		if (rising_edge(clk)) then
			if reset_n = '0' then
				...
				elsif(filter_switch = "10") then
				    LdacValue <= L_filter_lpf1000;
					RdacValue <= RadcValue;
					
                elsif(filter_switch = "01") then
                    LdacValue <= LadcValue;
					RdacValue <= R_filter_lpf300;
			    else
					LdacValue <= L_filter_lpf1000;
					RdacValue <= R_filter_lpf300;
				end if;
